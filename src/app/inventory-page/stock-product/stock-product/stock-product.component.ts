...
import {getControlErrorMessage, valueRequired} from "../../../../util/form-control-validators";

@Component({
  selector: 'app-stock-product',
  templateUrl: './stock-product.component.html'
})
export class StockProductComponent extends FormBuilding implements LoadableComponent, OnInit{
